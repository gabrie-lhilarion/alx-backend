...
class Server:
    ...
    def get_hyper_index(
        ...
        details with resilience to deletions.
        ...
        """
        assert isinstance(index, int) and index >= 0, "must non -ve int."
        assert isinstance(page_size, int) and page_size > 0, "must be+ int."
