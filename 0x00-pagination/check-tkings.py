...
class Server:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        ...
        assert isinstance(page, int) and page > 0, "Page number must be a positive int."
        assert isinstance(page_size, int) and page_size > 0, "Page size must be a positive int."
